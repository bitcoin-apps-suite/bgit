...
interface ExampleOptions {
  ...
  importSetup?: TsDsl<ts.Expression> | ((imp: TsDsl<ts.Expression>) => TsDsl<ts.Expression>);
...
declare class TsDslContext {
   ...
   * ```
   */
  example(node: TsDsl, options: ExampleOptions | undefined, astOptions?: Parameters<typeof TypeScriptRenderer.astToString>[0]): string;
}
//#endregion
...
type Header$1 = MaybeArray<string> | null | undefined;
...
declare class TypeScriptRenderer implements Renderer {
  ...
  constructor(args?: {
    header?: MaybeFunc<(ctx: RenderContext<TsDsl>) => Header$1>;
    preferExportAll?: boolean;
...
type Pipes$1 = Array<Pipe>;
type PipeResult = Pipes$1 | Pipe;
type PushPipes = (target: Pipes$1, pipes: PipeResult) => Pipes$1;
...
interface BaseResolverContext$1 extends DollarTsDsl {
  /**
...
interface NumberResolverContext$1 extends BaseResolverContext$1 {
  /**
...
interface ObjectResolverContext$1 extends BaseResolverContext$1 {
  /**
...
interface StringResolverContext$1 extends BaseResolverContext$1 {
  /**
...
interface ValidatorResolverContext$1 extends BaseResolverContext$1 {
  operation: IR.Operation;
  /**
   * Provides access to commonly used symbols within the plugin.
   */
  symbols: BaseResolverContext$1['symbols'] & {
    schema: Symbol;
  };
}
...
interface NumberResolverContext extends BaseResolverContext {
  /**
   * Nodes used to build different parts of the number schema.
   */
  nodes: {
...
interface ObjectResolverContext extends BaseResolverContext {
  /**
   * Nodes used to build different parts of the object schema.
   */
  nodes: {
...
interface StringResolverContext extends BaseResolverContext {
  /**
   * Nodes used to build different parts of the string schema.
   */
  nodes: {
...
interface ValidatorResolverContext extends BaseResolverContext {
  operation: IR.Operation;
  /**
   * Provides access to commonly used symbols within the plugin.
   */
...
type Header = MaybeFunc$1<(ctx: RenderContext) => MaybeArray$1<string> | null | undefined>;
type UserOutput = {
  /**
...
//#endregion
export { Client$2 as A, MaybeArray$1 as B, MaybeTsDsl as C, Client as D, TsDslContext as E, Casing as F, OperationPath as I, OperationStrategy as L, Client$4 as M, Client$5 as N, PluginHandler as O, Client$6 as P, IR as R, keywords as S, TypeTsDsl as T, $ as _, Plugin as a, TypeScriptRenderer as b, OpenApiOperationObject as c, OpenApiResponseObject as d, OpenApiSchemaObject as f, ExpressionTransformer as g, TypeTransformer as h, DefinePlugin as i, Client$3 as j, Client$1 as k, OpenApiParameterObject as l, Logger as m, UserConfig as n, OpenApi as o, Context as p, Input as r, OpenApiMetaObject as s, Config as t, OpenApiRequestBodyObject as u, DollarTsDsl as v, TsDsl as w, regexp as x, reserved as y, LazyOrAsync as z };
//# sourceMappingURL=config-Dis5Gu6e.d.mts.map